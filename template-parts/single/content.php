...
<div class="blog-title d-flex flex-wrap align-items-center justify-content-center justify-content-md-between align-self-start w-100 my-5 px-5 px-lg-0">
    ...
    <div class="d-flex flex-row">
        <a 
            href="https://twitter.com/share?url=<?php echo get_permalink();?>" 
            class="social-link me-4 hvr-hang" 
            onclick="window.open(this.href, 'Twitter share','width=500', 'height=400');return false;"
        >
