...
<div class="container-fluid bg-dark-blue d-flex flex-column justify-content-center align-items-center py-3">
    ...
    <div class="d-flex flex-wrap flex-lg-nowrap d-flex-lg-inline justify-content-center">
        <a href="#" class="fs-6 text-white me-2 me-lg-4 text-center text-lg-start my-3 my-md-0"><?php pll_e("Privacy Policy"); ?></a>
        <a href="#" class="fs-6 text-white text-center text-lg-start my-3 my-md-0"><?php pll_e("Terms & Conditions"); ?></a>
    </div>
</div>