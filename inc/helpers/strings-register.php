...
/**
 *  File to register custom Polylang strings
 * @author Frank Ponte
 */
...
pll_register_string("theme", "All posts", "Spanisch a la carte Theme");
pll_register_string("theme", "Category", "Spanisch a la carte Theme");
pll_register_string("theme", "Author", "Spanisch a la carte Theme");
pll_register_string("theme", "Search", "Spanisch a la carte Theme");
